...
To measure how IP and Actor effects change over time I select a GAM model for several reasons. Firstly, our research question is to investigate how these effects change over time. If I was to use a model that forced a relationship it would be unable to reflect the reality that these effects
